...
public class HomeTest extends javax.swing.JFrame {
    ...
    public HomeTest() {
        ...
        JTreeProcess.setSubjectCombox(cbMonHoc, SubjectDAO.getArraySubject());
        String monHoc = cbMonHoc.getItemAt(0).trim();
        String maMon = SubjectDAO.getMaMonHoc(monHoc);
        lbquizID.setText(String.valueOf(QuizDAO.getDeThiRandom(maMon)));
    }
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(27, 27, 27)
                        .addComponent(cbMonHoc, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(lbgo)))
    ...
    public void setUserInform() {
        ...
        lbname.setText(UserInformation.name);//name bang inf
...
//                    UserInformation.ngayThi=java.sql.Date.valueOf(lbDate.getText());
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if (monHoc.equals("--select--")) {
            ...
            alt.alter("Please select SubjectID have to Exam!");
        } else {
            alert_messager alt = new alert_messager();
    ...
    private void cbMonHocItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbMonHocItemStateChanged
        ...
        if (lbquizID.getText() != null) {
            maDe = lbquizID.getText().trim();// lay gia tri tex chuyen thanh kieu integer  
            /*  DeThi rs = QuizDAO.getDeThi(maDe);
            tongCau = rs.getDsCauHoi().trim().split(";").length;
            tongDiem = rs.getTongDiem();
            time = rs.getTime(); */
            Quizinformation();
            tongCau = UserInformation.tongsoCau;
            time = UserInformation.timetest;
            tongDiem = UserInformation.tongdiem;
            
            lbTotalQues.setText(Integer.toString(tongCau));
            lbTotalMark.setText(Float.toString(tongDiem));
            lbExamTime.setText(Long.toString(time));
        } else {
            lbTotalQues.setText(null);
            lbTotalMark.setText(null);
            lbExamTime.setText(null);
        }
    ...
    public void Quizinformation() {
        try {
            ...
            int rowCount = 0;
            while (rs.next()) {
                UserInformation.timetest = rs.getInt("thoigianthi");
                UserInformation.tongdiem = rs.getInt("tongdiem");
                rowCount++;
            }
            UserInformation.tongsoCau = rowCount;
