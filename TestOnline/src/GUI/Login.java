...
//                st.setString("pass", password);
                //st.setString(Authentication.md5("pass", password);
                st.setString(1, txtuser.getText());
                st.setString(2, Authentication.md5(txtpassword.getText()));
                ...
                if (flag == false) {
                    ...
                    switch (permission) {
                        case "admin":
                            ...
                            log.info(UserInformation.name + " login successful!");
                            break;
                        case "teacher":
                            this.dispose();
                            home.setVisible(true);
                        ...
                        default:
                            ...
                            log.error("Your user not validate!");
                            break;
                    }
                }
